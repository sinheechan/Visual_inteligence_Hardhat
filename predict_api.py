...
from general import update_options
...
if __name__ == '__main__':
    ...
    # Run app
    app.run(host='127.0.0.1', port=5000, debug=False) # Don't use debug=True, model will be loaded twice (https://stackoverflow.com/questions/26958952/python-program-seems-to-be-running-twice)
